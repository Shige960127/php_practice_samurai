...
if (isset($_POST['submit'])) {
    try {
        ...
        $stmt_register -> bindValue(':product_code', $_POST['product_code'], PDO::PARAM_INT);
        $stmt_register -> bindValue(':product_name', $_POST['product_name'], PDO::PARAM_STR);
        $stmt_register -> bindValue(':price', $_POST['price'], PDO::PARAM_INT);
        $stmt_register -> bindValue(':stock_quantity', $_POST['stock_quantity'], PDO::PARAM_INT);
        $stmt_register -> bindValue(':vendor_code', $_POST['vendor_code'], PDO::PARAM_INT);

        $stmt_register -> execute();
        $count = $stmt_register -> rowCount();
        ...
        <article class="registration">
            ...
            <form action="create.php" method="post" class="registration-form">
                <div>
                    ...
                    <label for="pstock_quantity">在庫数</label>
